...
public class Main_From extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main__from);
        drawer = (DrawerLayout) findViewById(R.id.drawer_layout_main_from);
        ...
        int alto = (display.getHeight()) - 480;
        ...
        final NavigationView navegador_local = (NavigationView) findViewById(R.id.main_from_nav);
        ...
        boton_menu = (Button) findViewById(R.id.btn_menu_main_from);
        ...
        menu_text3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Main_From.this, my_rides.class));
                Main_From.this.finish();
            }
        });
        ...
        menu_text5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View viewIn) {
                startActivity(new Intent(Main_From.this, configuracion.class));
                Main_From.this.finish();
            }
        });
        ...
        edit1.setText("From: Loading current location...");
        ...
        boton_continuar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Main_From.this, main_to.class));
                Main_From.this.finish();
            }
        });
        ...
        from_button_regresar  = (Button) findViewById(R.id.from_button_regresar);
        from_button_regresar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Main_From.this, pet_sumary.class));
                Main_From.this.finish();
            }
        });
    ...
    public void onConnectionSuspended(int i) {
        Dialogos.mensaje(Main_From.this, "Conexion Suspendida del Servicio de GPS");
    }

    @Override
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        Dialogos.mensaje(Main_From.this, "Falla de Conexion al Servicio de GPS");
    }
        ...
        switch (requestCode) {
            case MY_PERMISSIONS_REQUEST_LOCATION: {
                ...
                if (grantResults.length > 0
                    ...
                    Dialogos.mensaje(Main_From.this, "permission denied GPS");
                }
                return;
            }
    ...
    public void refreshPlacesData() {
        ...
        Global.origen = mMap.addMarker(markerOptions);
        ...
        try {
            ...
            if (addresses.size() > 0) {
               ...
               String calleNombre = addresses.get(0).getFeatureName();
                ...
                if (subLocality != null) {
                    edit1.setText("From: " + address);
                    Global.domicilio1 = edit1.getText().toString();
                    System.out.println("address: "+address);
                    System.out.println("locality: "+locality);
                    System.out.println("calleNombre: "+calleNombre);
                    ...
                    if (subLocality != null) {
                        edit1.setText("From: " + locality + "," + subLocality);
                        Global.domicilio1 = edit1.getText().toString();
                        System.out.println("Entre al else");


                    } else {
                        edit1.setText("From: " + locality);
                        Global.domicilio1 = edit1.getText().toString();
                        System.out.println("Entre al otro else");
