...
public class cotizador extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cotizador);
        drawer = (DrawerLayout) findViewById(R.id.drawer_layout_cotizador);
        ...
        final NavigationView navegador_local = (NavigationView) findViewById(R.id.cotizador_nav);
        ...
        menu_text3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(cotizador.this, my_rides.class));
        ...
        menu_text5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View viewIn) {
                startActivity(new Intent(cotizador.this, configuracion.class));
                cotizador.this.finish();
            }
        });
        ...
        select_car_button_regresar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(cotizador.this, select_car.class));
                cotizador.this.finish();
            }
        });
        ...
        if (MySQL.Conectar()) {
            sql= "SELECT * FROM petgo_afiliados" ;
            sql +=     " WHERE STATUS=1";
           ...
           // sql += "WHERE status=1";
            try {
                ...
                Dialogos.mensaje(cotizador.this, "There is a connection problem with your wifi or your data plan. Verify that your device has internet connection");
            }
        } else {
            // falla de conexion
            MySQL.cerrarConexion();
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        try {
            ...
            Dialogos.mensaje(cotizador.this, e.getMessage());
            e.printStackTrace();
        }
    ...
    public void onConnectionSuspended(int i) {
        Dialogos.mensaje(cotizador.this, "Conexion Suspendida del Servicio de GPS");
    }

    @Override
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        Dialogos.mensaje(cotizador.this, "Falla de Conexion al Servicio de GPS");
    }
        ...
        switch (requestCode) {
            case MY_PERMISSIONS_REQUEST_LOCATION: {
                ...
                if (grantResults.length > 0
                    ...
                    Dialogos.mensaje(cotizador.this, "permission denied GPS");
                }
                return;
            }
    ...
    protected void crearRuta(String type) {
        ...
        Call<Example> call = service.getDistanceDuration("imperial", Global.origen.getPosition().latitude + "," + Global.origen.getPosition().longitude, Global.destino.getPosition().latitude + "," + Global.destino.getPosition().longitude, type);
        System.out.println("1: "+Global.origen.getPosition().latitude );
        System.out.println("1.1: "+Global.origen.getPosition().longitude );
        System.out.println("2: "+ Global.destino.getPosition().latitude );
        System.out.println("2.1"+Global.destino.getPosition().longitude );
            ...
            public void onResponse(Response<Example> response, Retrofit retrofit) {
                try {
                    ...
                    for (int i = 0; i < response.body().getRoutes().size(); i++) {
                        ...
                        //Global.kilometros= response.body().getRoutes().get(i).getLegs().get(i).getDistance().getValue().doubleValue();
                        ...
                        line = mMap.addPolyline(new PolylineOptions()
                            ...
                            millas = distance.replace("mi", "");

                            System.out.println("millas origial: " + distance);
                            System.out.println("millas sin el mi:" + millas);
                            Global.millas = Double.parseDouble(millas);
                            System.out.println("millas origial: " + distance);
                            System.out.println("mi o ft sin el mi o ft  :" + millas);
                       /*
                            millas = distance.replace("mi", "");
...
//////////////////////////////////////////////////////
                        System.out.println("global: " + Global.millas);
                        if (Global.tipoUnidad == 1) {
                            Button sedanNegro = (Button) findViewById(R.id.tipo_carro);
                            sedanNegro.setBackgroundDrawable(getResources().getDrawable(R.drawable.petgo_icons_sedan_negro));
                            if (Global.millas <= 10) {
                                System.out.println("Menor de 10 en el 1");
                                Global.precio = 20.00;
                            }
                            if (Global.millas >= 20 && Global.millas <= 100) {
                                System.out.println("Es mayor a 20 en el 1");
                                Global.precio = (1.80 * Global.millas) + 20.00;
                            }
                            if (Global.millas >= 100) {
                                System.out.println("Mayor a 100 en el 1");
                                Global.precio = (1.50 * Global.millas) + 20.00;
                            }
                            precio.setText("$" + Global.precio.toString());

                        }
//////////////////////////////////////////////////////
                        if (Global.tipoUnidad == 2) {
                            Button htbkNegro = (Button) findViewById(R.id.tipo_carro);
                            htbkNegro.setBackground(getResources().getDrawable(R.drawable.petgo_icons_htbk_negro));
                            if (Global.millas <= 10) {
                                System.out.println("Menor de 10 en el 2");
                                Global.precio = 25.00;
                            }
                            if (Global.millas >= 25 && Global.millas <= 100) {
                                System.out.println("Es mayor a 20 en el 2");
                                Global.precio = (1.70 * Global.millas) + 25.00;
                            }
                            if (Global.millas >= 100) {
                                System.out.println("Mayor a 100 en el 2");
                                Global.precio = (1.50 * Global.millas) + 25.00;
                            }
                            precio.setText("$" + Global.precio.toString());

                        }
//////////////////////////////////////////////////////
                        if (Global.tipoUnidad == 3) {
                            Button suvNegro = (Button) findViewById(R.id.tipo_carro);
                            suvNegro.setBackground(getResources().getDrawable(R.drawable.petgo_icons_suv_negro));
                            if (Global.millas <= 10) {
                                System.out.println("Menor de 10 en el 3");
                                Global.precio = 25.00;
                            }
                            if (Global.millas >= 20 && Global.millas <= 100) {
                                System.out.println("Es mayor a 20 en el 3");

                                Global.precio = (2 * Global.millas) + 25.00;
                            }
                            if (Global.millas >= 100) {
                                System.out.println("Mayor a 100 en el 3");

                                Global.precio = (1.80 * Global.millas) + 25.00;
                            }
...
//////////////////////////////////////////////////////
                        ...
                        if (Global.tipoUnidad == 4) {
                            Button suvNegro = (Button) findViewById(R.id.tipo_carro);
                            suvNegro.setBackground(getResources().getDrawable(R.drawable.petgo_icons_minivan_negro));

                            if (Global.millas <= 10) {
                                System.out.println("Menor de 10 en el 4");
                                Global.precio = 30.00;
                            }
                            if (Global.millas >= 30 && Global.millas <= 100) {
                                System.out.println("Es mayor a 20 en el 4");

                                Global.precio = (2.50 * Global.millas) + 30.00;

                            }
                            if (Global.millas >= 100) {
                                System.out.println("Mayor a 100 en el 4");

                                Global.precio = (2.20 * Global.millas) + 30.00;
                            }
                            precio.setText("$" + Global.precio.toString());
